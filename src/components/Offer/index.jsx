...
export function Offer({offer}) {
    ...
    return (
        <div className="bg-gradient-to-r from-primary-light to-primary-dark p-4 rounded-md flex flex-col gap-4 max-w-96">
            ...
            <div>
                <p className="font-light text-sm text-white">{description}</p>
                <p className="font-thin text-xs text-white">{verse}</p>
            </div>
            <div className="flex gap-2 items-end cursor-pointer" onClick={() => handleCopy(bankInfo, setIsCopyBanco)}>
                <img src="/banco.png" alt="banco bradesco" className="h-5" width="103" height="23"/>
                <span className="font-medium text-xs lg:text-base text-white">{bankInfo}</span>
            ...
            <div className="flex gap-2 items-center cursor-pointer"  onClick={() => handleCopy(pix, setIsCopyPix)}>
                <img src="/pix.png" alt="pix" className="h-5" width="63" height="28"/>
                <span className="font-medium text-sm lg:text-base text-white">{pix}</span>
